...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'hero-pattern': "linear-gradient(to bottom, rgba(15, 15, 19, 0.9), rgba(15, 15, 19, 1)), url('https://images.unsplash.com/photo-1523712999610-f77fbcfc3843?auto=format&fit=crop&q=80')",
